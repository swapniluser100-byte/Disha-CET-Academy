(function () {
  ...
  function showRenewalScreen(detail) {
    ...
    el.innerHTML =
      ...
      '<div style="font-size:14.5px;color:#C9CFDD;line-height:1.6;">This website\'s subscription payment is overdue. Please contact SitePragati to renew access and restore the site.</div>' +
      dueLine +
      "</div>";
